...
gg <- ggplot(output_data, aes(x = xaxis, y = SLpc, color = strategy, alpha = alpha)) +
      ...
      location == "UMIC" & disease == "Influenza-1957-X" ~ scale_x_continuous(limits=c(-5,5),breaks=seq(-5,5,by=2.5),expand=c(0,0),position="bottom",labels=scales::label_parse()),
      location == "HIC" & disease == "Influenza-1957-X" ~ scale_x_continuous(limits=c(-3,3),breaks=seq(-3,3,by=1.5),expand=c(0,0),position="bottom",labels=scales::label_parse()),
      ...
      location == "UMIC" & disease == "Influenza-1918-X" ~ scale_x_continuous(limits=c(-5,5),breaks=seq(-5,5,by=2.5),expand=c(0,0),position="bottom",labels=scales::label_parse()),
      ...
      location == "UMIC" & disease == "Covid-Omicron-X" ~ scale_x_continuous(limits=c(-5,5),breaks=seq(-5,5,by=2.5),expand=c(0,0),position="bottom",labels=scales::label_parse()),
      location == "HIC" & disease == "Covid-Omicron-X" ~ scale_x_log10(limits=c(1e-3,1e+1),breaks=c(1e-3,1e-2,1e-1,1e+0,1e+1),expand=c(0,0),position="bottom",labels = scales::trans_format("log10", scales::math_format(10^.x))),
      ...
      location == "HIC" & disease == "Covid-Delta-X" ~ scale_x_log10(limits=c(1e-3,1e+1),breaks=c(1e-3,1e-2,1e-1,1e+0,1e+1),expand=c(0,0),position="bottom",labels = scales::trans_format("log10", scales::math_format(10^.x))),
      location == "LLMIC" & disease == "Covid-Wildtype-X" ~ scale_x_continuous(limits=c(-4,4),breaks=seq(-4,4,by=2),expand=c(0,0),position="bottom"),
      location == "UMIC" & disease == "Covid-Wildtype-X" ~ scale_x_log10(limits=c(1e-3,1e+1),breaks=c(1e-3,1e-2,1e-1,1e+0,1e+1),expand=c(0,0),position="bottom",labels = scales::trans_format("log10", scales::math_format(10^.x))),
      location == "HIC" & disease == "Covid-Wildtype-X" ~ scale_x_log10(limits=c(1e-3,1e+1),breaks=c(1e-3,1e-2,1e-1,1e+0,1e+1),expand=c(0,0),position="bottom",labels = scales::trans_format("log10", scales::math_format(10^.x))),
