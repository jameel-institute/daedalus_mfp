...
%Adherence to NPIs
pmod=0.4223;%lockdown delta%from fitting
...
pr.p3=0.0006;%proportion of asymptomatic self-isolating
pr.p4=0.0006;%proportion of symptomatic self-isolating
...
pr.Hmax=22.9357*sum(data.Npop)/(10^5);
%pr.thu=0.90*pr.Hmax;
pr.thl=0.30*pr.Hmax;
...
arate=105.1017*sum(data.Npop)/(10^5);
