function output = dd_run_postprocessing(data,dis,i,p2,output,tout,yout)
...
if i==5;
    ...
    output.g     = [output.Tout,output.Xout,output.hwout,...
    ...
    output.f     = [output.Tout,sum(output.Iout,2),sum(output.Hout,2),sum(output.Dout,2),...
