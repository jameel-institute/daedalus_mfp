...
gg <- ggplot(output_data, aes(x = x, y = y, fill = strategy)) +
      ...
      location == "UMIC" & disease == "Influenza-2009-X" ~ scale_y_continuous(limits=c(0,80),breaks=seq(0,80,20),expand=c(0,0),position="right"),
      location == "HIC" & disease == "Influenza-2009-X" ~ scale_y_continuous(limits=c(0,60),breaks=seq(0,60,15),expand=c(0,0),position="right"),
      ...
      location == "UMIC" & disease == "Influenza-1957-X" ~ scale_y_continuous(limits=c(0,100),breaks=seq(0,100,25),expand=c(0,0),position="right"),
      location == "HIC" & disease == "Influenza-1957-X" ~ scale_y_continuous(limits=c(0,60),breaks=seq(0,60,15),expand=c(0,0),position="right"),
