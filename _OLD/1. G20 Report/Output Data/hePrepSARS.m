function [pr,vx,NN,n,ntot,na,NNbar,NNrep,Dout,beta]=hePrepSARS(data,numInt,inp1,inp2)%,R0,del)
...
Ta=1;%asymptomatic
pr.g1=1/Ta;%finite for next-generation matrix, pr.p1=1 prevents asymptomatic cases
% pr.gX=1/2.1;%mild
Ts=1;%symptomatic
pr.g2=(1-ph)/Ts;
Threc=23.5;%hospitalised
pr.g3=(1-pd)/Threc;
...
vx.scv1=    0.65;                       %infection-blocking efficacy
vx.p1v1=    0;                          %disease-blocking efficacy          
vx.hv1=     1-((1-0.80)/(1-vx.scv1));   %severe-disease-blocking efficacy
vx.dv1=     0;                          %death-blocking efficacy
vx.trv1=    0.45;                       %transmission-blocking efficacy
...
vx.aratep1= [0;0;0;arate];

%Period 2 - working-age
vx.startp2= tpoints(2);
vx.aratep2= [0;0;arate;0];%to be split across all economic sectors in heSimCovid19vax.m
...
ifr=    [0.017	0.017	0.017	0.017	0.024	0.024	0.024	0.024	0.089	0.089	0.089	0.089	0.255	0.255	0.255	0.255	0.177];
pdgh=   ifr./ihr;
