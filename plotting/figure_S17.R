...
output_table <- output_data %>%
                ...
                group_by(location, disease, strategy) %>%
                summarise(median_1  = quantile(gdpl_1,  0.50),
                          q1_1      = quantile(gdpl_1,  0.25),
                          q3_1      = quantile(gdpl_1,  0.75),
                          median_2  = quantile(gdpl_2,  0.50),
                          q1_2      = quantile(gdpl_2,  0.25),
                          q3_2      = quantile(gdpl_2,  0.75),
                          median_3  = quantile(gdpl_3,  0.50),
                          q1_3      = quantile(gdpl_3,  0.25),
                          q3_3      = quantile(gdpl_3,  0.75),
                          median_4  = quantile(gdpl_4,  0.50),
                          q1_4      = quantile(gdpl_4,  0.25),
                          q3_4      = quantile(gdpl_4,  0.75),
                          median_5  = quantile(gdpl_5,  0.50),
                          q1_5      = quantile(gdpl_5,  0.25),
                          q3_5      = quantile(gdpl_5,  0.75),
                          median_6  = quantile(gdpl_6,  0.50),
                          q1_6      = quantile(gdpl_6,  0.25),
                          q3_6      = quantile(gdpl_6,  0.75),
                          median_7  = quantile(gdpl_7,  0.50),
                          q1_7      = quantile(gdpl_7,  0.25),
                          q3_7      = quantile(gdpl_7,  0.75),
                          median_8  = quantile(gdpl_8,  0.50),
                          q1_8      = quantile(gdpl_8,  0.25),
                          q3_8      = quantile(gdpl_8,  0.75),
                          median_9  = quantile(gdpl_9,  0.50),
                          q1_9      = quantile(gdpl_9,  0.25),
                          q3_9      = quantile(gdpl_9,  0.75),
                          median_10 = quantile(gdpl_10, 0.50),
                          q1_10     = quantile(gdpl_10, 0.25),
                          q3_10     = quantile(gdpl_10, 0.75),
                          min_any   = unique(min_any),
                          min_med   = unique(min_med),
                          min_q3    = unique(min_q3)) %>%
                mutate(across(c(median_1,q1_1,q3_1,median_2,q1_2,q3_2,
                                median_3,q1_3,q3_3,median_4,q1_4,q3_4,
                                median_5,q1_5,q3_5,median_6,q1_6,q3_6,
                                median_7,q1_7,q3_7,median_8,q1_8,q3_8,
                                median_9,q1_9,q3_9,median_10,q1_10,q3_10), 
                              ~ ifelse(.x < 10, sprintf("%.1f", .x), sprintf("%.0f", .x)))) %>%
                ...
                mutate(median_10 = if_else(str_detect(strategy, "Elimination") & disease == "Covid-Wildtype-X",  paste0(median_10,"\\phantom{.}"), median_10)) %>%
