...
output_data  <- lapply(output_files, add_scenario_cols) %>% bind_rows() %>% order_scenario_cols() %>%
                ...
                ungroup() %>%
                filter(strategy == "Economic Closures") %>%
...
gg <- ggplot(output_data, aes(x = xaxis, y = yaxis, color = cost_eff, fill = cost_eff)) +
      ...
      facetted_pos_scales(
        ...
        y = list (
        location == "LLMIC" & disease == "Influenza-2009-X" ~ scale_y_continuous(limits=c(-20,60),breaks=seq(-20,60,20),expand=c(0,0),position="right"),
        location == "UMIC" & disease == "Influenza-2009-X" ~ scale_y_continuous(limits=c(-5,15),breaks=seq(-5,15,5),expand=c(0,0),position="right"),
        location == "HIC" & disease == "Influenza-2009-X" ~ scale_y_continuous(limits=c(-5,15),breaks=seq(-5,15,5),expand=c(0,0),position="right"),
        location == "LLMIC" & disease == "Influenza-1957-X" ~ scale_y_continuous(limits=c(-40,120),breaks=seq(-40,120,40),expand=c(0,0),position="right"),
        location == "UMIC" & disease == "Influenza-1957-X" ~ scale_y_continuous(limits=c(-15,45),breaks=seq(-15,45,15),expand=c(0,0),position="right"),
        location == "HIC" & disease == "Influenza-1957-X" ~ scale_y_continuous(limits=c(-10,30),breaks=seq(-10,30,10),expand=c(0,0),position="right"),
        location == "LLMIC" & disease == "Influenza-1918-X" ~ scale_y_continuous(limits=c(-300,900),breaks=seq(-300,900,300),expand=c(0,0),position="right"),
        location == "UMIC" & disease == "Influenza-1918-X" ~ scale_y_continuous(limits=c(-300,900),breaks=seq(-300,900,300),expand=c(0,0),position="right"),
        location == "HIC" & disease == "Influenza-1918-X" ~ scale_y_continuous(limits=c(-300,900),breaks=seq(-300,900,300),expand=c(0,0),position="right"),
        location == "LLMIC" & disease == "Covid-Omicron-X" ~ scale_y_continuous(limits=c(-50,150),breaks=seq(-50,150,50),expand=c(0,0),position="right"),
        location == "UMIC" & disease == "Covid-Omicron-X" ~ scale_y_continuous(limits=c(-30,90),breaks=seq(-30,90,30),expand=c(0,0),position="right"),
        location == "HIC" & disease == "Covid-Omicron-X" ~ scale_y_continuous(limits=c(-30,90),breaks=seq(-30,90,30),expand=c(0,0),position="right"),
        location == "LLMIC" & disease == "Covid-Delta-X" ~ scale_y_continuous(limits=c(-150,450),breaks=seq(-150,450,150),expand=c(0,0),position="right"),
        location == "UMIC" & disease == "Covid-Delta-X" ~ scale_y_continuous(limits=c(-150,450),breaks=seq(-150,450,150),expand=c(0,0),position="right"),
        location == "HIC" & disease == "Covid-Delta-X" ~ scale_y_continuous(limits=c(-150,450),breaks=seq(-150,450,150),expand=c(0,0),position="right"),
        location == "LLMIC" & disease == "Covid-Wildtype-X" ~ scale_y_continuous(limits=c(-100,300),breaks=seq(-100,300,100),expand=c(0,0),position="right"),
        location == "UMIC" & disease == "Covid-Wildtype-X" ~ scale_y_continuous(limits=c(-100,300),breaks=seq(-100,300,100),expand=c(0,0),position="right"),
        location == "HIC" & disease == "Covid-Wildtype-X" ~ scale_y_continuous(limits=c(-100,300),breaks=seq(-100,300,100),expand=c(0,0),position="right"),
