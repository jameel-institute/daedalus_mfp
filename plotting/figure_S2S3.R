...
p4 <- ggplot(mm, aes(x = xvalue, y = yvalue, color = variable, group = sample)) +
      ...
      labs(title = "", x = "", y = "")
p4 <- ggdraw(p4) + draw_text(mm_labs$xlabel, x = mm_labs$x, y = mm_labs$y, hjust = 0.5, vjust = 0.5, size = 9)

ggsave("figure_S3.png", plot = p4, height = 14, width = 10)