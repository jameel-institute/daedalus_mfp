...
table = readtable('../../Data/Preparedness/_10.UKprevalence.csv');
tt    = table.t;
I     = table.I;
t1    = 1:244; 
I     = interp1(tt,I,t1)'; 
...
table = readtable('../../Data/Preparedness/_10.UKtesting.csv');
...
table = readtable('../../Data/Preparedness/_10.UKcases.csv');
