function f=heMakeDs(NN,x,data,wfh)
...
%Transport:
matA(1:lx,1:lx)=    matA(1:lx,1:lx)+    repmat(x',lx,1).*   data.travelA3(1).*  NNrep(1:lx,1:lx).*  repmat(1-wfh,lx,1).*repmat(1-wfh',1,lx);%home-working has a compound effect
