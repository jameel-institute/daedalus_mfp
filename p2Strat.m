function data = p2Strat(data,inp3);
    ...
    if strcmp(inp3,'No Closures');
        ...
        data.imand  = [NaN];%configuration numbers with mandatory distancing
        data.inext  = [5];%index corresponds to event number in event function, values number of next configuration
